...
namespace coconet
{
	namespace cotensor
	{
		...
		void mul_scalar_(CoTensor<f32>& tensor, f32 value);
		void mul_scalar_(CoTensor<f64>& tensor, f64 value);
		void mul_scalar_(CoTensor<u8>& tensor, u8 value);
		void mul_scalar_(CoTensor<i8>& tensor, i8 value);
		void mul_scalar_(CoTensor<i16>& tensor, i16 value);
		void mul_scalar_(CoTensor<i32>& tensor, i32 value);
		void mul_scalar_(CoTensor<i64>& tensor, i64 value);
